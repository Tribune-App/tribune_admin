...
-- Tiempo de generación: 18-09-2019 a las 02:29:14
...
INSERT INTO `compra` (`id_compra`, `fecha`, `id_proveedor`, `id_mediopago`, `id_comprobante`, `id_usuario`, `id_moneda`, `subtotal`, `descuento`, `total`, `conversion`, `efectivo`, `vuelto`, `flestado`, `feregistro`, `feregistro_anular`) VALUES
(1, '2019-09-18 06:15:09', 1, 2, 2, 1, 1, '45.00', '0.00', '45.00', '0.00', '0.00', '0.00', 1, '2019-09-18 06:15:09', NULL);
...
INSERT INTO `compradetalle` (`id_compradetalle`, `id_compra`, `item`, `id_producto`, `id_unidad`, `cantidad`, `precio`, `total`, `flestado`, `feregistro`) VALUES
(1, 1, 0, 10, 3, '3.00', '15.00', '45.00', 0, '2019-09-18 06:15:09');
...
--
-- Volcado de datos para la tabla `creditoproveedor`
--

INSERT INTO `creditoproveedor` (`id_creditoproveedor`, `id_proveedor`, `id_compra`, `total`, `deuda`, `flestado`, `feregistro`) VALUES
(1, 1, 1, '45.00', '45.00', 0, '2019-09-18 06:15:09');
...
(1, 10, 'Por compra', 'Sin observación', '3.00', '0.00', '13.00', 1, NULL, NULL, '2019-09-18 06:15:09');
...
(10, 10, '13.00', '0.00', '13.00', '2019-09-12 04:00:33'),
...
--
ALTER TABLE `creditoproveedor`
  MODIFY `id_creditoproveedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
