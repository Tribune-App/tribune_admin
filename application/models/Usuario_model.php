...
class Usuario_model extends CI_Model {
    ...
    {
        //Consulta
        $this->db->select('usuario.*, per.nombre as nombre_perfil,pers.nro_doc as nro_doc_personal,pers.nombres as nombres_personal,pers.apellido_paterno as apaterno_personal,pers.apellido_materno as amaterno_personal');
        $this->db->from('usuario');
