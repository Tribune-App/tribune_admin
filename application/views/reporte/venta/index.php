          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Reportes <small>Ventas</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Rep. Ventas<small>Listado</small></h2>
                  ...
                  <div class="row">
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <strong style="color:#169F85">Rango de Fechas:</strong>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <strong style="color:#169F85">Comprobantes:</strong>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <strong style="color:#169F85">Medios de Pagos:</strong>
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                        <strong style="color:#169F85">Estados:</strong>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <br>
                        <button class="btn btn-block btn-success pull-center m-t-n-xs" id="btn_buscar"><strong><i class="fa fa-search"></i> BUSCAR</strong></button>
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="table-responsive">        
                      <table id="tabla_reporte_venta" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th>Fecha</th>
