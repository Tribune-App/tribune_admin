          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Mantenimientos <small>Medios de Pagos</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Medios de Pagos<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlNuevoMedioPago" type="button"><span class="bold">NUEVO MEDIO</span></button>
                    </p>
                    <div class="row">
                    ...
                    <p>
                      ...
                      <div class="modal inmodal" id="mdlNuevoMedioPago" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                ...
                                <div class="modal-body">
                                    <?php echo form_open(base_url('mediopago/save'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formMedioPago', 'style' => 'overflow:hidden'));?>
                    ...
                    <div class="modal inmodal" id="mdlEditarMedioPago" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                ...
                                <div class="modal-body">
                                    <?php echo form_open(base_url('mediopago/update'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formMedioPago', 'style' => 'overflow:hidden'));?>
                                      <input type="hidden" id="id_mediopago" name="id_mediopago" value="">
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Nombre</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                           if (is_array($mediospagos)):
                                foreach ($mediospagos AS $mediopago){
                        ?>
                        <tr>
                          <td><?php echo $mediopago->id_mediopago; ?></td>
                          <td><?php echo $mediopago->nombre; ?></td>
                          <td>
                            <?php if($mediopago->flestado==0){
                                    echo 'Activo';
                                  }else{
                                    echo 'Inactivo';
                                  }
                          ...
                          <td><?php echo $mediopago->feregistro; ?></td>
                          <td>
                              <button type="button" data-toggle="modal" data-target="#mdlEditarMedioPago" data-idmediopago="<?php echo $mediopago->id_mediopago; ?>" class="btn edit btn-sm btn-warning m-b-none"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Editar Medio de Pago"></i></button>
                              <button onclick="eliminarMedioPago('<?php echo $mediopago->id_mediopago; ?>')" class="btn btn-sm btn-danger m-b-none" data-toggle="tooltip" data-placement="top" title="Eliminar Medio de Pago"><i class="fa fa-ban"></i></button>
                          </td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
