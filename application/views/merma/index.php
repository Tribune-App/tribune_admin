          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Almacén <small>Mermas</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Mermas<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlNuevoMerma" type="button"><span class="bold">NUEVA MERMA</span></button>
                    </p>
                    <div class="row">
                    ...
                    <p>
                      ...
                      <div class="modal inmodal" id="mdlNuevoMerma" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                    <h4 class="modal-title">Nueva Merma</h4>
                                </div>
                                <div class="modal-body">
                                    <?php echo form_open(base_url('merma/save'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formPerfil', 'style' => 'overflow:hidden'));?>
                                      <div class="form-group col-md-12 col-sm-12 col-xs-12" >
                                        <label class="control-label">(*)Productos: </label>
                                        <select class="form-control input-sm chosen-select" id="id_producto" name="id_producto" >
                                          <option value="">---Seleccionar---</option>
                                          <?php if($productos): foreach ($productos as $producto) { ?>
                                              <option value="<?php echo $producto->id_producto; ?>">
                                              (<?php echo $producto->cantactual_stock; ?> <?php echo $producto->abreviatura_unidad; ?>)  <?php echo $producto->nombre; ?>
                                              </option>
                                          <?php } endif; ?>
                                        </select>
                                      </div>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $merma->nombre_unidad; ?></td>
                          <td><?php echo $merma->observacion; ?></td>
                          <td><?php echo $merma->cantidad; ?></td>
                          <td><?php echo $merma->login_usuario; ?></td>
                          <td><?php echo $merma->feregistro; ?></td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
                    </table>
