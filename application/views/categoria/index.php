          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Mantenimientos <small>Categorías</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Categorías<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlNuevoCategoria" type="button"><span class="bold">NUEVA CATEGORÍA</span></button>
                    </p>
                    <div class="row">
                    ...
                    <p>
                      ...
                      <div class="modal inmodal" id="mdlNuevoCategoria" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                ...
                                <div class="modal-body">
                                    <?php echo form_open(base_url('categoria/save'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formCategoria', 'style' => 'overflow:hidden'));?>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Nombre</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Categoría" required>
                                        </div>
                                      </div>
                                      <div class="row">
                                          <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="modal inmodal" id="mdlEditarCategoria" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                ...
                                <div class="modal-body">
                                    <?php echo form_open(base_url('categoria/update'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formCategoria', 'style' => 'overflow:hidden'));?>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $categoria->feregistro; ?></td>
                          <td>
                              <button type="button" data-toggle="modal" data-target="#mdlEditarCategoria" data-idcategoria="<?php echo $categoria->id_categoria; ?>" class="btn edit btn-sm btn-warning m-b-none"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Editar Categoría"></i></button>
                              <button onclick="eliminarCategoria('<?php echo $categoria->id_categoria; ?>')" class="btn btn-sm btn-danger m-b-none" data-toggle="tooltip" data-placement="top" title="Eliminar Categoría"><i class="fa fa-ban"></i></button>
                          </td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
