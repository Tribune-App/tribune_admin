          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Créditos de Proveedores <small>Amortizaciones</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Amortizaciones<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                           if (is_array($creditosproveedoresdetalles)):
                                foreach ($creditosproveedoresdetalles AS $creditoproveedordetalle){
                        ?>
                        <tr>
                          <td><?php echo $creditoproveedordetalle->id_creditoproveedordetalle; ?></td>
                          <td><?php echo $creditoproveedordetalle->feregistro_creditoproveedordetalle; ?></td>
                          <td><?php if($creditoproveedordetalle->tipo_doc_proveedor==1){
                                    echo 'DNI';
                                  }else{
                                    echo 'RUC';
                                  }
                            ?></td>
                          <td><?php echo $creditoproveedordetalle->nro_doc_proveedor; ?></td>
                          <td><?php echo $creditoproveedordetalle->proveedor; ?></td>
                          <td><?php echo $creditoproveedordetalle->id_compra; ?></td>
                          <td><?php echo $creditoproveedordetalle->feregistro_compra; ?></td>
                          <td><?php echo $creditoproveedordetalle->simbolo_moneda; ?></td>
                          <td><?php echo $creditoproveedordetalle->total_compra; ?></td>
                          <td style="color: green"><?php echo $creditoproveedordetalle->total_creditoproveedordetalle; ?></td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
                    </table>
