          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Créditos de Clientes <small>Amortizaciones</small></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php
                           if (is_array($creditosclientesdetalles)):
                                foreach ($creditosclientesdetalles AS $creditoclientedetalle){
                        ?>
                        <tr>
                          <td><?php echo $creditoclientedetalle->id_creditoclientedetalle; ?></td>
                          <td><?php echo $creditoclientedetalle->feregistro_creditoclientedetalle; ?></td>
                          <td><?php if($creditoclientedetalle->tipo_doc_cliente==1){
                                    echo 'DNI';
                                  }else{
                                    echo 'RUC';
                                  }
                            ?></td>
                          <td><?php echo $creditoclientedetalle->nro_doc_cliente; ?></td>
                          <td><?php echo $creditoclientedetalle->cliente; ?></td>
                          <td><?php echo $creditoclientedetalle->id_venta; ?></td>
                          <td><?php echo $creditoclientedetalle->feregistro_venta; ?></td>
                          <td><?php echo $creditoclientedetalle->simbolo_moneda; ?></td>
                          <td><?php echo $creditoclientedetalle->total_venta; ?></td>
                          <td style="color: green"><?php echo $creditoclientedetalle->total_creditoclientedetalle; ?></td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
                    </table>
