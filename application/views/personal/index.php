          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Mantenimientos <small>Personales</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Personales<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlNuevoPersonal" type="button"><span class="bold">NUEVO PERSONAL</span></button>
                    </p>
                    <div class="row">
                    ...
                    <p>
                      ...
                      <div class="modal inmodal" id="mdlNuevoPersonal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                ...
                                <div class="modal-body">
                                    <?php echo form_open_multipart(base_url('personal/save'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formPersonal', 'style' => 'overflow:hidden'));?>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <select class="form-control input-sm chosen-select" id="id_empresa" name="id_empresa" required>
                                            <option value="">---Seleccionar---</option>
                                            <?php if($empresas): foreach ($empresas as $empresa) { ?>
                                                <option value="<?php echo $empresa->id_empresa; ?>">
                                                 <?php echo $empresa->nro_doc; ?> || <?php echo $empresa->razon_social; ?>
                                                </option>
                                            <?php } endif; ?>
                                          </select>
                                        </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <select class="form-control input-sm chosen-select" id="sexo" name="sexo" required>
                                            <option value="">---Seleccionar---</option>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="file" class="form-control-file" id="upload" name="fotopers"  accept="image/x-png,image/jpg,image/jpeg">
                                        </div>
                                      </div>
                                      <div class="form-group">
                    ...
                    <div class="modal inmodal" id="mdlEditarPersonal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                ...
                                <div class="modal-body">
                                    <?php echo form_open_multipart(base_url('personal/update'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formPersonal', 'style' => 'overflow:hidden'));?>
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Empresa</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <select class="form-control input-sm chosen-select" id="edit_id_empresa" name="edit_id_empresa">
                                            <option value="">---Seleccionar---</option>
                                            <?php if($empresas): foreach ($empresas as $empresa) { ?>
                                                <option value="<?php echo $empresa->id_empresa; ?>">
                                                 <?php echo $empresa->nro_doc; ?> || <?php echo $empresa->razon_social; ?>
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Nombres</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="text" class="form-control" name="edit_nombres" id="edit_nombres" placeholder="Nombres" required>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Apellido Paterno</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="text" class="form-control" name="edit_apellido_paterno" id="edit_apellido_paterno" placeholder="Apellido Paterno" required>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Apellido Materno</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="text" class="form-control" name="edit_apellido_materno" id="edit_apellido_materno" placeholder="Apellido Materno" required>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Sexo</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <select class="form-control input-sm chosen-select" id="edit_sexo" name="edit_sexo" required>
                                            <option value="">---Seleccionar---</option>
                                            <option value="1">Masculino</option>
                                            <option value="2">Femenino</option>
                                          </select>
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Foto</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="file" class="form-control-file" id="upload" name="editfotopers"  accept="image/x-png,image/jpg,image/jpeg">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Teléfono</label>
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Dirección</label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="text" class="form-control" name="edit_direccion" id="edit_direccion" placeholder="Dirección">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Referencia</label>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php 
                              if($personal->ruta_foto){
                                  $imagen_personal=base_url('imagenes/personal/'.$personal->ruta_foto);
                                }else{
                                  $imagen_personal=base_url('imagenes/personal/personal_default.png');
                                }
                            ?>
                          <img src="<?php echo $imagen_personal ?>" style="width: 90px !important; height: 70px !important">
                          </td>
                          <td><?php echo $personal->razon_social_empresa; ?></td>
                          <td>
                            <?php if($personal->tipo_doc==1){
                                    echo 'DNI';
                                  }elseif($cliente->tipo_doc==2){
                                    echo 'RUC';
                                  }else{
                                    echo '';
                                  }
                          ...
                          <td><?php echo $personal->feregistro; ?></td>
                          <td>
                              <button type="button" data-toggle="modal" data-target="#mdlEditarPersonal" data-idpersonal="<?php echo $personal->id_personal; ?>" class="btn edit btn-sm btn-warning m-b-none"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Editar Personal"></i></button>
                              <button onclick="eliminarPersonal('<?php echo $personal->id_personal; ?>')" class="btn btn-sm btn-danger m-b-none" data-toggle="tooltip" data-placement="top" title="Eliminar Personal"><i class="fa fa-ban"></i></button>
                          </td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
