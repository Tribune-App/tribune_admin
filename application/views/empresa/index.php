          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Mantenimientos <small>Empresas</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Empresa<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      ...
                      <?php $total_empresas=0; if(is_array($empresas)){ $total_empresas=count($empresas); } else{ $total_empresas;} ?>
                      <?php if($total_empresas == 0) { ?>
                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#mdlNuevoEmpresa" type="button"><span class="bold">NUEVA EMPRESA</span></button>
                      <?php }?>
                    </p>
                    <div class="row">
                    ...
                    <?php if($total_empresas == 0) { ?>
                      <div class="modal inmodal" id="mdlNuevoEmpresa" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content animated bounceInRight">
                                ...
                                <div class="modal-body">
                                    <?php echo form_open_multipart(base_url('empresa/save'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formEmpresa', 'style' => 'overflow:hidden'));?>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="file" class="form-control-file" id="upload" name="imgemp"  accept="image/x-png,image/jpg,image/jpeg">
                                        </div>
                                      </div>
                                      <div class="form-group">
                    ...
                    <?php if($total_empresas > 0) { ?>
                      <div class="modal inmodal" id="mdlEditarEmpresa" tabindex="-1" role="dialog" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content animated bounceInRight">
                                  <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                  ...
                                  <div class="modal-body">
                                      <?php echo form_open_multipart(base_url('empresa/update'), array('novalidate'=>'','class' => ' form-horizontal form-label-left', 'id'=>'formProveedor', 'style' => 'overflow:hidden'));?>
                                        ...
                                        <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Logo</label>
                                          <div class="col-md-9 col-sm-9 col-xs-12">
                                          <input type="file" class="form-control-file" id="upload" name="editimgemp"  accept="image/x-png,image/jpg,image/jpeg">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12">(*)Teléfono</label>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php 
                                if($empresa->ruta_imagen){
                                    $logo=base_url('imagenes/empresa/'.$empresa->ruta_imagen);
                                  }else{
                                    $logo=base_url('imagenes/empresa/empresa_default.png');
                                  }
                            ?>
                            <img src="<?php echo $logo ?>" style="width: 90px !important; height: 80px !important">
                          </td>
                          <td>
                            <?php if($empresa->tipo_doc==1){
                                    echo 'DNI';
                                  }elseif($empresa->tipo_doc==2){
                                    echo 'RUC';
                                  }else{
                                    echo '';
                                  }
                          ...
                          <td><?php echo $empresa->nro_doc; ?></td>
                          <td><?php echo $empresa->razon_social; ?></td>
                          <td><?php echo $empresa->direccion; ?></td>
                          <td><?php echo $empresa->telefono1; ?></td>
                          
                          <td><?php echo $empresa->feregistro; ?></td>
                          <td>
                              <button type="button" data-toggle="modal" data-target="#mdlEditarEmpresa" data-idempresa="<?php echo $empresa->id_empresa; ?>" class="btn edit btn-sm btn-warning m-b-none"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Editar Empresa"></i></button>
                          </td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
