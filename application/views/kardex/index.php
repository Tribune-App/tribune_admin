          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Almacén <small>Kárdex</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kárdex<small>Listado</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td><?php echo $kardex->id_kardex; ?></td>
                          <td><?php echo $kardex->concepto; ?></td>
                          <td><?php echo $kardex->observacion; ?></td>
                          <td><?php echo $kardex->nombre_producto; ?></td>
                          <td style="color: green"><?php echo $kardex->cantentrada .' '. $kardex->abreviatura_unidad;?></td>
                          <td style="color: red"><?php echo $kardex->cantsalida .' '. $kardex->abreviatura_unidad;?></td>
                          <td><?php echo $kardex->cantsaldo .' '. $kardex->abreviatura_unidad;?></td>
                          <td><?php echo $kardex->id_venta; ?></td>
                          <td><?php echo $kardex->id_compra; ?></td>
                          <td><?php echo $kardex->id_merma; ?></td>
                          <td><?php echo $kardex->feregistro; ?></td>
                        </tr>
                        <?php } endif;?>
                      </tbody>
                    </table>
